...
extension HomeViewController: HomeViewProtocol {
    ...
    func updateCardViewValues(cardViewModel: CardViewModel) {
        incomeLabel.text = "\("currency".localized) \(cardViewModel.incomes)"
        expenseLabel.text = "\("currency".localized) \(cardViewModel.expenses)"
        totalBalance.text = "\("currency".localized) \(cardViewModel.total)"
    }
